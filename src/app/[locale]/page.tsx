  ...
  return (
    <div>
      ...
      <PageSection
        ...
        rightContent={
          <div className="w-2/3 flex-col justify-center items-center text-gray-dark">
            <p className="text-center mt-4">{t("HomePage.description.one")}</p>
            <p className="text-center mt-4">{t("HomePage.description.two")}</p>
      ...
      <PageSection
        bgColor="blue-dark"
        content={
          <div className="flex flex-col justify-center text-gray-light w-full gap-8 py-5">
            <div>
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/web2" className="cursor-pointer">
                <Button variant="full" bgColor="blue-dark">
                  {t("HomePage.web2")}
                </Button>
              </Link>
